              ...
              <div className="p-8 bg-gray-50 border-2 rounded-[2rem] space-y-6">
                ...
                <div className="grid md:grid-cols-2 gap-4 items-start">
                  ...
                  <div className="space-y-2">
                    ...
                    <textarea
                      className="w-full bg-white border-2 p-3 rounded-xl font-mono text-xs min-h-[180px]"
                      value={(selected.features || []).join('\n')}
                      onChange={(e) =>
                        updateProduct({
                          features: normalizeFeaturesInput(e.target.value),
                        })
                      }
                      placeholder={`Imagen de 2 Megapixel (1920 x 1080)
Iluminación mínima 0.009 lux
Día / Noche Real (ICR)
Lente 2.8 mm
IR 30 metros
IP66 exterior`}
                    />
                    <div className="text-[10px] font-black text-gray-500">
                      Escribe o pega <b>una característica por línea</b>. También acepta comas si vienes pegando texto antiguo.
                    </div>
                  </div>
                </div>
